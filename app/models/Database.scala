...
object Database extends Schema {
  ...
  val usersToSales = oneToManyRelation(usersTable, salesTable).via((u, s)=>u.id===s.userID)
  val usersToBookings = oneToManyRelation(usersTable, bookingsTable).via((u, b)=>u.id===b.userID)
}